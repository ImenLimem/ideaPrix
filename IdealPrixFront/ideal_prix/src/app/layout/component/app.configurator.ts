...
export class AppConfigurator {
    ...
    if (isPlatformBrowser(this.platformId)) {
        // Mettre "rose" comme couleur primaire par défaut
        this.layoutService.layoutConfig.update((state) => ({ ...state, primary: 'rose' }));

        // Appliquer immédiatement la couleur par défaut
        this.updateColors({ stopPropagation: () => {} }, 'primary', { name: 'rose' });

        // Changer de preset si nécessaire
