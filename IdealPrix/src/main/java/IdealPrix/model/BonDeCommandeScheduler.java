...
public class BonDeCommandeScheduler {
    ...
    private void envoyerMail(BonDeCommande bc, String sujet) {
        ...
        String corps = "<html>" +
                ...
                "<tr><td style='border: 1px solid #ccc; padding: 8px;'>Numéro du bon de commande</td><td style='border: 1px solid #ccc; padding: 8px;'>" + bc.getNumeroBonCommande() + "</td></tr>" +
                "<tr><td style='border: 1px solid #ccc; padding: 8px;'>Description</td><td style='border: 1px solid #ccc; padding: 8px;'>" + bc.getDescription() + "</td></tr>" +
                "<tr><td style='border: 1px solid #ccc; padding: 8px;'>Fournisseur</td><td style='border: 1px solid #ccc; padding: 8px;'>" + fournisseurNom + " " + fournisseurPrenom + "</td></tr>" +
                "<tr><td style='border: 1px solid #ccc; padding: 8px;'>Date de commande</td><td style='border: 1px solid #ccc; padding: 8px;'>" + (bc.getDateCommande() != null ? bc.getDateCommande().toLocalDate() : "N/A") + "</td></tr>" +
                "<tr><td style='border: 1px solid #ccc; padding: 8px;'>Date d'expédition</td><td style='border: 1px solid #ccc; padding: 8px;'>" + (bc.getDateExpedition() != null ? bc.getDateExpedition().toLocalDate() : "N/A") + "</td></tr>" +
                "<tr><td style='border: 1px solid #ccc; padding: 8px;'>Date de livraison</td><td style='border: 1px solid #ccc; padding: 8px;'>" + (bc.getDateLivraison() != null ? bc.getDateLivraison().toLocalDate() : "N/A") + "</td></tr>" +
